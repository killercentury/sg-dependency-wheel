  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var fill = function(d) {
        ...
        // Change the original logic to use the last 3 char to generate the color distribution for StyleGuide
        return "hsl(" + parseInt(((packageNames[d.index][packageNames[d.index].length-3].charCodeAt() - 97) / 26) * 360, 10) + ",90%,70%)";
      };
